...
contract Llama is ERC20, Ownable {
    ...
    address public taxWallet = 0xB9fDB9D141F842Ce7DD8Bc66764EAf36061C1826;
    mapping (address => bool) public _isWhiteListedFromFee;
    mapping (address => bool) public _isBlackListed;

    uint256 public maxWalletLimit = 1000000000000 * 10 ** decimals();

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("Llama", "Llma") {
    ...
    function _transfer(
        ...
        require(!_isBlackListed[sender] && !_isBlackListed[recipient], "Account blacklisted");
    ...
    function blackListWallet(address account) public onlyOwner{
        _isBlackListed[account] = true;
    }

    function unBlackListWallet(address account) public onlyOwner{
